...
public class Ventana extends javax.swing.JFrame {
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        try {
            if (jF1.showOpenDialog(null) == jF1.APPROVE_OPTION) {
                ...
                //llamamos al reader para que escriba el texto del archivo en el
                //jTextArea
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        try {
            //esto esta sacado de internet y sirve para saber si en el fileChooser
            //elegimos en este caso guardar o cancelar
            if (jF1.showSaveDialog(null) == jF1.APPROVE_OPTION) {
                String rutaArchivo = jF1.getSelectedFile().getAbsolutePath();        
                //sacamos el texto del JtextArea
